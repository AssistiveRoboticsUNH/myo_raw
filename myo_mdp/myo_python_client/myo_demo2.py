...
class MyoDemo2(object):
    ...
    def __init__(self, use_euler=False, task_type=1):
        data_path = '../data'+str(task_type)
        print data_path

        orientation_l = genfromtxt(data_path+'/prompt_l.dat', delimiter=',')
        orientation_u = genfromtxt(data_path+'/prompt_u.dat', delimiter=',')
