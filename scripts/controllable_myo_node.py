...
def main(msg):
    ...
    calibrate_myo_sub_speech = rospy.Subscriber('/exercise/detected_state', String, MyThread.calibrateMyo)
...
if __name__ == '__main__':
    ...
    if len(sys.argv)>1 and sys.argv[1] == 'client' and 'myo-only' not in sys.argv:
        print "myo running in client mode with separate IMU sensors"
        # requires IMU sensors to run first
